            ...
            <div>
                ...
                <Jumbotron className="jumbotron-trails-search">
                    <div className = "jumbotron-trails-search-filters">
                        ...
                        <p style={{color:"white"}}>Use the filters below to find your perfect trail!</p>
                        <p style={{color:"white"}}>Filter on National Park:</p>
                        ...
                        <p style={{color:"white"}}>Filter on Max Difficulty</p>
                        <Dropdown>
                            <Dropdown.Toggle variant="success" id="dropdown-basic">
                        ...
                        <p></p>
                        <p style={{color:"white"}}>Filter on Max Distance (miles)</p>
                        <Dropdown>
                            <Dropdown.Toggle variant="success" id="dropdown-basic">
                        ...
                        <p></p>
                        <p style={{color:"white"}}>Filter on Max Elevation Gain (feet)</p>
                        <Dropdown>
                            <Dropdown.Toggle variant="success" id="dropdown-basic">
                        ...
                        <p></p>
                        <p style={{color:"white"}}>Filter on Min Rating</p>
                        <Dropdown>
                            <Dropdown.Toggle variant="success" id="dropdown-basic">
